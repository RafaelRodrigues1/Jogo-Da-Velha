...
public class JogoDaVelha extends javax.swing.JFrame {
    ...
    private void lbl02MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl02MouseClicked
        if(jogou02 == 1){
            ...
            vez = 0;
            jogB02=1;
            if(jogB00==1 && jogB01==1 && jogB02==1 || jogB02==1 && jogB12==1 && jogB22==1 || jogB02==1 && jogB11==1 && jogB20==1){
            ...
            vez = 1;
            jogX02=1;
            if(jogX00==1 && jogX01==1 && jogX02==1 || jogX02==1 && jogX12==1 && jogX22==1 || jogX02==1 && jogX11==1 && jogX20==1){
                JOptionPane.showMessageDialog(null, "X ganhou!", "Vencedor", 1);
            }
        }
        if(jogou00 == 1 && jogou01 == 1 && jogou02 == 1 && jogou10 == 1 && jogou11 == 1 &&
                jogou12 == 1 && jogou20 == 1 && jogou21 == 1 && jogou22 == 1){
    ...
    private void lbl00MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl00MouseClicked
        if(jogou00 == 1){
            ...
            vez = 0;
            jogB00=1;
            if(jogB00==1 && jogB01==1 && jogB02==1 || jogB00==1 && jogB10==1 && jogB20==1 || jogB00==1 && jogB11==1 &&                  jogB22==1){
                JOptionPane.showMessageDialog(null, "Bola ganhou!", "Vencedor", 1);
            }
        }else if(vez == 0 || vez == 2){
            x00.setVisible(true);
            ...
            vez = 1;
            jogX00=1;
            if(jogX00==1 && jogX01==1 && jogX02==1 || jogX00==1 && jogX10==1 && jogX20==1 || jogX00==1 && jogX11==1 &&                  jogX22==1){
                JOptionPane.showMessageDialog(null, "X ganhou!", "Vencedor", 1);
            }
        }
    ...
    private void lbl01MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl01MouseClicked
        if(jogou01 == 1){
            ...
            vez = 0;
            jogB01=1;
            if(jogB00==1 && jogB01==1 && jogB02==1 || jogB01==1 && jogB11==1 && jogB21==1){
                JOptionPane.showMessageDialog(null, "Bola ganhou!", "Vencedor", 1);
            }
        }else if(vez == 0 || vez == 2){
            x01.setVisible(true);
            ...
            vez = 1;
            jogX01=1;
            if(jogX00==1 && jogX01==1 && jogX02==1 || jogX01==1 && jogX11==1 && jogX21==1){
                JOptionPane.showMessageDialog(null, "X ganhou!", "Vencedor", 1);
            }
        }
        if(jogou00 == 1 && jogou01 == 1 && jogou02 == 1 && jogou10 == 1 && jogou11 == 1 &&
    ...
    private void lbl12MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl12MouseClicked
        if(jogou12 == 1){
            ...
            vez = 0;
            jogB12=1;
            if(jogB02==1 && jogB12==1 && jogB22==1 || jogB10==1 && jogB11==1 && jogB12==1){
                JOptionPane.showMessageDialog(null, "Bola ganhou!", "Vencedor", 1);
            }
        }else if(vez == 0 || vez == 2){
            x12.setVisible(true);
            ...
            vez = 1;
            jogX12=1;
            if(jogX02==1 && jogX12==1 && jogX22==1 || jogX10==1 && jogX11==1 && jogX12==1){
                JOptionPane.showMessageDialog(null, "X ganhou!", "Vencedor", 1);
            }
        }
        if(jogou00 == 1 && jogou01 == 1 && jogou02 == 1 && jogou10 == 1 && jogou11 == 1 &&
    ...
    private void lbl22MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl22MouseClicked
        if(jogou22 == 1){
            ...
            vez = 0;
            jogB22=1;
            if(jogB02==1 && jogB12==1 && jogB22==1 || jogB20==1 && jogB21==1 && jogB22==1 || jogB00==1 && jogB11==1 &&                  jogB22==1){
                JOptionPane.showMessageDialog(null, "Bola ganhou!", "Vencedor", 1);
            }
        }else if(vez == 0 || vez == 2){
            x22.setVisible(true);
            ...
            vez = 1;
            jogX22=1;
            if(jogX02==1 && jogX12==1 && jogX22==1 || jogX20==1 && jogX21==1 && jogX22==1 || jogX00==1 && jogX11==1 &&                  jogX22==1){
                JOptionPane.showMessageDialog(null, "X ganhou!", "Vencedor", 1);
            }
        }
        if(jogou00 == 1 && jogou01 == 1 && jogou02 == 1 && jogou10 == 1 && jogou11 == 1 &&
    ...
    private void lbl11MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl11MouseClicked
        if(jogou11 == 1){
            ...
            vez = 0;
            jogB11=1;
            if(jogB00==1 && jogB11==1 && jogB22==1 || jogB01==1 && jogB11==1 && jogB21==1 || jogB02==1 && jogB11==1 &&                  jogB20==1 || 
                    jogB10==1 && jogB11==1 && jogB12==1){
                JOptionPane.showMessageDialog(null, "Bola ganhou!", "Vencedor", 1);
            }
        }else if(vez == 0 || vez == 2){
            x11.setVisible(true);
            ...
            vez = 1;
            jogX11=1;
            if(jogX00==1 && jogX11==1 && jogX22==1 || jogX01==1 && jogX11==1 && jogX21==1 || jogX02==1 && jogX11==1 &&                      jogX20==1 || 
                    jogX11==1 && jogX11==1 && jogX12==1){
                JOptionPane.showMessageDialog(null, "X ganhou!", "Vencedor", 1);
            }
        }
        if(jogou00 == 1 && jogou01 == 1 && jogou02 == 1 && jogou10 == 1 && jogou11 == 1 &&
    ...
    private void lbl21MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl21MouseClicked
        if(jogou21 == 1){
            ...
            vez = 0;
            jogB21=1;
            if(jogB01==1 && jogB11==1 && jogB21==1 || jogB20==1 && jogB21==1 && jogB22==1){
                JOptionPane.showMessageDialog(null, "Bola ganhou!", "Vencedor", 1);
            }
        }else if(vez == 0 || vez == 2){
            x21.setVisible(true);
            ...
            vez = 1;
            jogX21=1;
            if(jogX01==1 && jogX11==1 && jogX21==1 || jogX20==1 && jogX21==1 && jogX22==1){
                JOptionPane.showMessageDialog(null, "X ganhou!", "Vencedor", 1);
            }
        }
        if(jogou00 == 1 && jogou01 == 1 && jogou02 == 1 && jogou10 == 1 && jogou11 == 1 &&
    ...
    private void lbl20MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl20MouseClicked
        if(jogou20 == 1){
            ...
            vez = 0;
            jogB20=1;
            if(jogB20==1 && jogB21==1 && jogB22==1 || jogB00==1 && jogB10==1 && jogB20==1 || jogB20==1 && jogB11==1 &&              jogB02==1){
                JOptionPane.showMessageDialog(null, "Bola ganhou!", "Vencedor", 1);
            }
        }else if(vez == 0 || vez == 2){
            x20.setVisible(true);
            ...
            vez = 1;
            jogX20=1;
            if(jogX20==1 && jogX21==1 && jogX22==1 || jogX00==1 && jogX10==1 && jogX20==1 || jogX20==1 && jogX11==1 &&                  jogX02==1){
                JOptionPane.showMessageDialog(null, "X ganhou!", "Vencedor", 1);
            }
        }
        if(jogou00 == 1 && jogou01 == 1 && jogou02 == 1 && jogou10 == 1 && jogou11 == 1 &&
    ...
    private void lbl10MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl10MouseClicked
        if(jogou10 == 1){
            ...
            vez = 0;
            jogB10=1;
            if(jogB10==1 && jogB11==1 && jogB12==1 || jogB00==1 && jogB10==1 && jogB20==1 ){
                JOptionPane.showMessageDialog(null, "Bola ganhou!", "Vencedor", 1);
            }
        }else if(vez == 0 || vez == 2){
            x10.setVisible(true);
            ...
            vez = 1;
            jogX10=1;
            if(jogX10==1 && jogX11==1 && jogX12==1 || jogX00==1 && jogX10==1 && jogX20==1 ){
                JOptionPane.showMessageDialog(null, "Bola ganhou!", "Vencedor", 1);
            }
        }
        if(jogou00 == 1 && jogou01 == 1 && jogou02 == 1 && jogou10 == 1 && jogou11 == 1 &&
